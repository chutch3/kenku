...
public sealed class ChapterDownloadedActionRecord(Actions action, DateTime performedAt, string seriesId, string chapterId) : ActionRecord(action, performedAt), IActionWithChapterRecord, IActionWithSeriesRecord
{
