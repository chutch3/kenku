...
/// <summary>Payload for <see cref="CleanupHandler"/>.</summary>
public record CleanupPayload(CleanupKind Kind);
...
public class CleanupHandler(IServiceScopeFactory scopeFactory) : IJobHandler
{
    ...
    public static string PayloadFor(CleanupKind kind) => JsonSerializer.Serialize(new CleanupPayload(kind));
