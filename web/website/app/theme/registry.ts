...
export const THEMES: Theme[] = [
    ...
    { id: 'mental-health', name: 'Mental Health Awareness', jaName: 'メンタルヘルス啓発', package: 'Health', seeds: { primary: '#32cd32', secondary: '#228b22', neutral: '#9ca3af' } },
    ...
    { id: 'non-binary', name: 'Non-Binary Pride', jaName: 'ノンバイナリー・プライド', package: 'Pride', seeds: { primary: '#fff700', secondary: '#9b59b6', neutral: '#2c3e50' } },
    { id: 'bisexual', name: 'Bisexual Pride', jaName: 'バイセクシュアル・プライド', package: 'Pride', seeds: { primary: '#d60270', secondary: '#0038a8', neutral: '#7c6f86' } },
    { id: 'pansexual', name: 'Pansexual Pride', jaName: 'パンセクシュアル・プライド', package: 'Pride', seeds: { primary: '#ff007f', secondary: '#00bfff', neutral: '#a3a3a3' } },
    ...
    { id: 'firefighter', name: 'Firefighter Support', jaName: '消防士支援', package: 'Service', seeds: { primary: '#ff0000', secondary: '#d3d3d3', neutral: '#2b2b2b' } },
    ...
    { id: 'global-peace', name: 'Global Peace', jaName: '世界平和', package: 'Justice', seeds: { primary: '#64b5f6', secondary: '#b39ddb', neutral: '#aeb6c2' } },
    ...
    { id: 'wabi-sabi', name: 'Wabi-Sabi', jaName: '侘寂', package: 'Heritage', seeds: { primary: '#8fbc8f', secondary: '#708090', neutral: '#a8a29e' } },
    { id: 'aizome', name: 'Indigo Dye', jaName: '藍染め', package: 'Heritage', seeds: { primary: '#0f2042', secondary: '#4682b4', neutral: '#7a8290' } },
    { id: 'akihabara', name: 'Modern Pop Culture', jaName: '現代カルチャー', package: 'Heritage', seeds: { primary: '#ff007f', secondary: '#00ffff', neutral: '#121212' } },
];
