...
const source = { key: 'src-old', seriesSourceName: 'WeebCentral', objId: 's1', idOnConnectorSite: '01BAD/Wrong-Slug', websiteUrl: null, useForDownload: true };
...
registerEndpoint('/v2/Search/WeebCentral/I Am A Hero', () => [
    {
        ...
        sourceIds: [{ key: 'sid-good', seriesSourceName: 'WeebCentral', objId: 'x', idOnConnectorSite: '01ABC', websiteUrl: 'https://weebcentral.com/series/01ABC', useForDownload: false }],
        fileLibraryId: null,
        originalLanguage: 'en',
        coverUrl: '',
    },
